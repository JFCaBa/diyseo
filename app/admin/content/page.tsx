  ...
  return (
    <section className="space-y-6">
      ...
      <div className="overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/80 shadow-2xl">
        <div className="grid grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)_120px_170px_170px] gap-3 border-b border-slate-800 bg-slate-950/70 px-4 py-3 text-xs font-semibold uppercase tracking-wide text-slate-500">
          <p>Title</p>
          <p>Site</p>
          <p>Status</p>
          <p>Created</p>
        ...
        <div className="divide-y divide-slate-800">
          {articles.map((article) => (
            <div
              key={article.id}
              className="grid grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)_120px_170px_170px] gap-3 px-4 py-4 text-sm text-slate-300"
            >
